...
record MinecraftVersionImpl(int first, int second, int third) implements Comparable<MinecraftVersionImpl>, MinecraftVersion {
    ...
    public static final MinecraftVersionImpl V1_21_5 = new MinecraftVersionImpl(1, 21, 5);
    public static final MinecraftVersionImpl V1_21_4 = new MinecraftVersionImpl(1, 21, 4);
